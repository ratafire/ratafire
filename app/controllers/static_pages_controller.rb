class StaticPagesController < ApplicationController
  ...
  def home
    ...
    @users_2 = User.where(:subscription_status_initial => "Approved",:homepage_fundable => true).order("homepage_fundable_weight asc").paginate(page: params[:fundable], :per_page => 2)
  	unless signed_in?
    else
