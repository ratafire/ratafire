class Majorpost < ActiveRecord::Base
  ...
  attr_accessible :content, :user_id, :project_id, :title, :tag_list, :m_u_inspirations_attributes, :m_p_inspirations_attributes, :m_m_inspirations_attributes, :m_e_inspirations_attributes, :video_attributes, :artwork_id, :published, :perlink, :video_id, :excerpt, :post_to_facebook, :post_to_facebook_page, :license
  belongs_to :user
  belongs_to :project
  ...
  #--- Validations ---
    ...
    validates_length_of :title, :maximum => 90, :message => "is too long! Maximum 90 characters."
