...
Devise.setup do |config|
    ...
    # config.secret_key = '79d3f388ec71867dd9f6a9e13804ea3925f8b695d185ce9eab1d23f982835d0d2be4ff10724a72b0b6557f3744777d46fdfd2091ddd0537844d1a58131e7e84a'

    # ==> Mailer Configuration
    # Configure the e-mail address which will be shown in Devise::Mailer,
    # note that it will be overwritten if you use your own mailer class
    # with default "from" parameter.
    config.mailer_sender = 'noreply@ratafire.com'
    ...
    # config.pepper = '349aafeba0dde7f9abeb782b949116cfd5eb8acd596308f6588240b6d7cccb99af2f0ef661e44c1d2e802f6b11c13824bbb5c25e10a0752d9054780bd790181a'
    ...
    if Rails.env.production?
        config.omniauth :facebook, ENV['FACEBOOK_KEY'], ENV['FACEBOOK_SECRET'],{:scope => 'email, user_about_me, user_location, user_website, user_education_history, user_friends',image_size: { width: 500, height: 500 }, secure_image_url: true}
        config.omniauth :facebookpages, ENV['FACEBOOK_KEY'], ENV['FACEBOOK_SECRET'],{:scope => 'manage_pages'}
        ...
        config.omniauth :facebook, ENV['FACEBOOK_KEY_TEST'], ENV['FACEBOOK_SECRET_TEST'],{:scope => 'email, user_about_me, user_location, user_website, user_education_history, user_friends',image_size: { width: 500, height: 500 }, secure_image_url: true}
        config.omniauth :facebookpages, ENV['FACEBOOK_KEY_TEST'], ENV['FACEBOOK_SECRET_TEST'],{:scope => 'manage_pages'}
