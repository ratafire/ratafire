...
Devise.setup do |config|
  ...
  if Rails.env.production?
    config.omniauth :facebook, ENV['FACEBOOK_KEY'], ENV['FACEBOOK_SECRET'],{:scope => 'email, user_about_me, user_location, user_website, user_education_history,read_stream, user_photos'}
    ...
    config.omniauth :facebook, ENV['FACEBOOK_KEY_TEST'], ENV['FACEBOOK_SECRET_TEST'],{:scope => 'email, user_about_me, user_location, user_website, user_education_history,read_stream, user_photos'}
